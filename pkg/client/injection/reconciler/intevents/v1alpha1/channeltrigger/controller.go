...
import (
	...
	channeltrigger "github.com/google/knative-gcp/pkg/client/injection/informers/intevents/v1alpha1/channeltrigger"
...
const (
	defaultControllerAgentName = "channeltrigger-controller"
	defaultFinalizerName       = "channeltriggers.internal.events.cloud.google.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	channeltriggerInformer := channeltrigger.Get(ctx)

	lister := channeltriggerInformer.Lister()
