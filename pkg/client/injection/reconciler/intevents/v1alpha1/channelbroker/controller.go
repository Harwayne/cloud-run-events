...
import (
	...
	channelbroker "github.com/google/knative-gcp/pkg/client/injection/informers/intevents/v1alpha1/channelbroker"
...
const (
	defaultControllerAgentName = "channelbroker-controller"
	defaultFinalizerName       = "channelbrokers.internal.events.cloud.google.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	channelbrokerInformer := channelbroker.Get(ctx)

	lister := channelbrokerInformer.Lister()
